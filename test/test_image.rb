...
class TestImage < Minitest::Test
  ...
  def test_color_pixel_out_of_image
    i = Image.new
    i.create(3,3)
    assert_equal(Image::ERROR_MSGS[:invalid_coords], i.color_pixel(0,0, "C"))
  end
  ...
  def test_draw_vertical_segment_with_coords_bigger_than_size
    i = Image.new
    i.create(3, 3)
    assert_equal(Image::ERROR_MSGS[:invalid_coords], i.draw_vertical_segment(1,4,3,"B"))
  end

  def test_draw_vertical_segment_with_invalid_column
    i = Image.new
    i.create(3, 3)
    assert_equal(Image::ERROR_MSGS[:invalid_coords], i.draw_vertical_segment(4,1,3,"B"))
  end

  def test_draw_vertical_segment_with_end_bigger_than_start
    i = Image.new
    i.create(3, 3)
    assert_equal(Image::ERROR_MSGS[:invalid_coords], i.draw_vertical_segment(2,2,1,"B"))
  end
  ...
  def test_draw_horizontal_segment_with_coords_bigger_than_size
    i = Image.new
    i.create(3, 3)
    assert_equal(Image::ERROR_MSGS[:invalid_coords], i.draw_horizontal_segment(1,4,3,"B"))
  end

  def test_draw_horizontal_segment_with_invalid_row
    i = Image.new
    i.create(3, 3)
    assert_equal(Image::ERROR_MSGS[:invalid_coords], i.draw_horizontal_segment(1,2,4,"B"))
  end

  def test_draw_horizontal_segment_with_end_bigger_than_start
    i = Image.new
    i.create(3, 3)
    assert_equal(Image::ERROR_MSGS[:invalid_coords], i.draw_horizontal_segment(2,1,2,"B"))
  end
